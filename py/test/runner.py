...
class SearchNoticeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SearchNoticeTestRunner.getenv("SEARCHNOTICE_TEST_LIVE")
        override = SearchNoticeTestRunner.getenv("SEARCHNOTICE_TEST_OVERRIDE")
        ...
        explain = SearchNoticeTestRunner.getenv("SEARCHNOTICE_TEST_EXPLAIN")
