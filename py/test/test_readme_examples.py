# SearchNotice SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SearchNoticeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SearchNoticeSDK(...) and SearchNoticeSDK.test(...) become
#      SearchNoticeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "searchnotice_sdk"
_SDK_CLASS = "SearchNoticeSDK"
