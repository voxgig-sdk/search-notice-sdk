...
from searchnotice_sdk.utility import register

# Load features
from searchnotice_sdk.feature.base_feature import SearchNoticeBaseFeature
from searchnotice_sdk.features import _has_feature, _make_feature
...
class SearchNoticeSDK:
    ...
    def get_utility(self):
        return SearchNoticeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SearchNoticeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Search(self, data=None) -> "SearchEntity":
        ...
        from searchnotice_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "SearchNoticeSDK":
        if sdkopts is None:
            sdkopts = {}
