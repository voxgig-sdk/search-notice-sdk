...
def make_error_util(ctx, err):
    if ctx is None:
        from searchnotice_sdk.core.context import SearchNoticeContext
        ctx = SearchNoticeContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, SearchNoticeError):
        errmsg = err.msg
    ...
    sdk_err = SearchNoticeError("", msg, ctx)
