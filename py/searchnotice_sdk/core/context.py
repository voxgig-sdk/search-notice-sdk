...
from searchnotice_sdk.core.helpers import get_ctx_prop, to_map
...
class SearchNoticeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, SearchNoticeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SearchNoticeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SearchNoticeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return SearchNoticeError(code, msg, self)
