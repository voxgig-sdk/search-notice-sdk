...
// `class AdviceEntity extends SearchNoticeEntityBase<Advice>`.
class SearchNoticeEntityBase<D = any> {
  name = ''
  name_ = ''
  Name = ''

  _client: SearchNoticeSDK
  _utility: Utility
  _entopts: any
  ...
  constructor(client: SearchNoticeSDK, entopts: any) {
    entopts = entopts || {}
