...
describe('exists', async () => {
  ...
  //
  // SearchNoticeSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof SearchNoticeSDK, true,
      'SearchNoticeSDK.test() must return a client synchronously')
  })
