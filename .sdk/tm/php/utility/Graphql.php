...
// SearchNotice SDK utility: graphql
//
...
class SearchNoticeGraphql
{
    ...
    // equivalent.
    public static function body(SearchNoticeContext $ctx): mixed
    {
    ...
    public static function errors(SearchNoticeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
