...
// SearchNotice SDK netsim feature
...
class SearchNoticeNetsimFeature extends SearchNoticeBaseFeature
{
    ...
    private function _simulate(SearchNoticeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SearchNoticeContext $ctx, array $applied): void
    {
        $client = $this->client;
