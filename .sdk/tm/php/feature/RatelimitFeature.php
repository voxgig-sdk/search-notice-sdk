...
// SearchNotice SDK ratelimit feature
...
class SearchNoticeRatelimitFeature extends SearchNoticeBaseFeature
{
    ...
    private function _acquire(SearchNoticeContext $ctx): void
    {
    ...
    private function _track(SearchNoticeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
