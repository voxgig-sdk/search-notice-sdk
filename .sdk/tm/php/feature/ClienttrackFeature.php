...
// SearchNotice SDK clienttrack feature
...
class SearchNoticeClienttrackFeature extends SearchNoticeBaseFeature
{
    ...
    public function PostConstruct(SearchNoticeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SearchNotice-SDK';
