...
// SearchNotice SDK timeout feature
...
class SearchNoticeTimeoutFeature extends SearchNoticeBaseFeature
{
    ...
    private function _with_timeout(SearchNoticeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SearchNoticeContext $_ctx, float $ms): void
    {
        $client = $this->client;
