...
// SearchNotice SDK idempotency feature
...
class SearchNoticeIdempotencyFeature extends SearchNoticeBaseFeature
{
    ...
    private function _mutating(SearchNoticeContext $ctx): bool
    {
