...
// SearchNotice SDK proxy feature
...
class SearchNoticeProxyFeature extends SearchNoticeBaseFeature
{
    ...
    public function init(SearchNoticeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SearchNoticeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
