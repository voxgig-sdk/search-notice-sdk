...
// SearchNotice SDK metrics feature
...
class SearchNoticeMetricsFeature extends SearchNoticeBaseFeature
{
    ...
    private function _record(SearchNoticeContext $ctx, bool $ok): void
    {
