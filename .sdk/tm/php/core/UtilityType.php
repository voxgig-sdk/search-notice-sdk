...
// SearchNotice SDK utility type

class SearchNoticeUtility
{
    ...
    public static function copy(SearchNoticeUtility $src): SearchNoticeUtility
    {
        $u = new SearchNoticeUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
