...
class SearchNoticeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SearchNoticeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = SearchNoticeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = SearchNoticeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
