...
class SearchNoticeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SearchNoticeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SearchNoticeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SearchNoticeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
