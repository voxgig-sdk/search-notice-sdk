...
// SearchNotice SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class SearchNoticeTransformResponse
{
    public static function call(SearchNoticeContext $ctx): mixed
    {
        ...
        $transform = SearchNoticeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
