...
// SearchNotice SDK utility: fetcher

class SearchNoticeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SearchNoticeSDK/1.0)';
    ...
    public static function call(SearchNoticeContext $ctx, string $fullurl, array $fetchdef): array
    {
