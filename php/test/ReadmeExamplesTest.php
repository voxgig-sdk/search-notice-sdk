...
// SearchNotice SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SearchNoticeSDK::test)
...
{
    private const SDK_CLASS = 'SearchNoticeSDK';
    ...
    private const SDK_BASE = 'searchnotice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../searchnotice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
