...
// SearchNotice SDK audit feature
...
class SearchNoticeAuditFeature extends SearchNoticeBaseFeature
{
    ...
    private function _emit(SearchNoticeContext $ctx, string $outcome): void
    {
