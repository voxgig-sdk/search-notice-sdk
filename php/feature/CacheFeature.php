...
// SearchNotice SDK cache feature
...
class SearchNoticeCacheFeature extends SearchNoticeBaseFeature
{
    ...
    private function _through(SearchNoticeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
