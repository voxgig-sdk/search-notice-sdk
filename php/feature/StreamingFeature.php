...
// SearchNotice SDK streaming feature
...
class SearchNoticeStreamingFeature extends SearchNoticeBaseFeature
{
    ...
    private function _iterate(SearchNoticeResult $result): \Generator
    {
    ...
    private function _streamable(SearchNoticeContext $ctx): bool
    {
