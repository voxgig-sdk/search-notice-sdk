...
// SearchNotice SDK telemetry feature
...
class SearchNoticeTelemetryFeature extends SearchNoticeBaseFeature
{
    ...
    private function _close(SearchNoticeContext $ctx, bool $ok): void
    {
