...
// SearchNotice SDK debug feature
...
class SearchNoticeDebugFeature extends SearchNoticeBaseFeature
{
    ...
    private function _finish(SearchNoticeContext $ctx, bool $ok): void
    {
