...
class SearchNoticeRbacFeature extends SearchNoticeBaseFeature
{
    ...
    private function _required(SearchNoticeContext $ctx): ?string
    {
    ...
    private function _reject(SearchNoticeContext $ctx, string $required): void
    {
    ...
    private function _track(SearchNoticeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
