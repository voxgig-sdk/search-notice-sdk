// Command SearchNotice-mcp is an MCP server exposing the SearchNotice
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SearchNotice_list  — list records of an entity
//	SearchNotice_load  — load a single record of an entity
//
