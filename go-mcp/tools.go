...
func registerTools(server *mcp.Server, client *sdk.SearchNoticeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "search-notice_list",
		Description: "List records from SearchNotice. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "search-notice_load",
		Description: "Load a single record from SearchNotice. " +
...
func runOp(client *sdk.SearchNoticeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SearchNoticeSDK, name string) (sdk.SearchNoticeEntity, error) {
