...
func searchBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("SEARCH_NOTICE_TEST_SEARCH_ENTID")
	...
	idmapResolved := core.ToMapAny(env["SEARCH_NOTICE_TEST_SEARCH_ENTID"])
	if idmapResolved == nil {
		idmapResolved = core.ToMapAny(idmap)
	}

	if env["SEARCH_NOTICE_TEST_LIVE"] == "TRUE" {
	...
	return &entityTestSetup{
		...
		idmap:         idmapResolved,
		env:           env,
		explain:       env["SEARCH_NOTICE_TEST_EXPLAIN"] == "TRUE",
		live:          live,
