...
function runner.env_override(m)
  local live = runner.getenv("SEARCH_NOTICE_TEST_LIVE")
  local override = runner.getenv("SEARCH_NOTICE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SEARCH_NOTICE_TEST_EXPLAIN")
