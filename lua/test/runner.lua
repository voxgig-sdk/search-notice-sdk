...
function runner.env_override(m)
  local live = runner.getenv("SEARCHNOTICE_TEST_LIVE")
  local override = runner.getenv("SEARCHNOTICE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SEARCHNOTICE_TEST_EXPLAIN")
