...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/search-notice` | `npm install @voxgig-sdk/search-notice` |
| Python | `voxgig-sdk-search-notice` | `pip install voxgig-sdk-search-notice` |
| PHP | `voxgig-sdk/search-notice` | `composer require voxgig-sdk/search-notice` |
| Golang | `github.com/voxgig-sdk/search-notice-sdk/go` | `go get github.com/voxgig-sdk/search-notice-sdk/go` |
| Ruby | `voxgig-sdk-search-notice` | `gem install voxgig-sdk-search-notice` |
| Lua | `voxgig-sdk-search-notice` | `luarocks install voxgig-sdk-search-notice` |
