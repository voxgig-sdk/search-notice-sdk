...
This API allows users to search for specific notice slips within a given database.

Learn more about Search Notice API at [adviceslip.com](https://adviceslip.com).

This is an unofficial SDK for the Search Notice public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/search-notice` | publish pending — [install from git tag](https://github.com/voxgig-sdk/search-notice-sdk/releases) |
| Python | `voxgig-sdk-search-notice` | publish pending — [install from git tag](https://github.com/voxgig-sdk/search-notice-sdk/releases) |
| PHP | `voxgig-sdk/search-notice` | publish pending — [install from git tag](https://github.com/voxgig-sdk/search-notice-sdk/releases) |
| Golang | `github.com/voxgig-sdk/search-notice-sdk/go` | `go get github.com/voxgig-sdk/search-notice-sdk/go@latest` |
| Ruby | `voxgig-sdk-search-notice` | publish pending — [install from git tag](https://github.com/voxgig-sdk/search-notice-sdk/releases) |
| Lua | `voxgig-sdk-search-notice` | publish pending — [install from git tag](https://github.com/voxgig-sdk/search-notice-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/search-notice-sdk/go-cli` | `go install github.com/voxgig-sdk/search-notice-sdk/go-cli/cmd/search-notice@latest` |
| Go MCP server | `github.com/voxgig-sdk/search-notice-sdk/go-mcp` | `go get github.com/voxgig-sdk/search-notice-sdk/go-mcp@latest` |
