...
func registerSDKWords(r *eng.Registry, client *sdk.SearchNoticeSDK) {
...
func runOp(client *sdk.SearchNoticeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
