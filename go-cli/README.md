...
AQL-driven CLI and REPL for the SearchNotice SDK. Positional arguments are
...
./search-notice-cli list search
./search-notice-cli load 1 search
./search-notice-cli load '{id:1}' search
